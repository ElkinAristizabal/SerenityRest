...
import sqa.petstore.task.user.PostUser;
...
public class PetStoreUserCreateStepDefinitions {
    ...
    public static void setUp ()  {
        ...
        user.should(
                seeThat("The response code is:", ResponseServerCode.was(), equalTo(404))
        );
    ...
    public void userUsesThePathUserToCreateANewUserWithTheInformation() {
        user.wasAbleTo(CallToAPI.en());
        path = Constants.constanstExcelUser(1,"Path");
        Map<String, String> excelData = Constants.constanstExcelUser(1, "Users");
        user.attemptsTo(
